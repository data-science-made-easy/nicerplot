if (file.exists('heatmap-tozo.xlsx')) { # plot figures from Excel file:
  ...
  nicerplot::nplot(d, type = c('heatmap'), title = c('Fractie bedrijven die TOZO gebruikt'), x_title = c('eigen vermogen 2020 (deciel)'), y_title = c('eigen vermogen 2021 (deciel)'), style = c('default'), open = FALSE)
