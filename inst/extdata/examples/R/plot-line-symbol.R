if (file.exists('line-symbol.xlsx')) { # plot figures from Excel file:
  ...
  nicerplot::nplot(d, type = c('line'), title = c('Ontwikkeling EMU-schuld in schokscenario's'), y_title = c('%-bbp'), x_lim = c(2017.5, 2025.5), line_symbol = c(0, 20, 20, 20), style = c('default'), open = FALSE)
